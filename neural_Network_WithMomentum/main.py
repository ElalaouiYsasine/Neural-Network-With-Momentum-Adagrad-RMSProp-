...
def momentum(W1, W2, b1, b2, dW1, dW2, db1, db2, alpha, beta, M1, M2, M3, M4):
    M1 = alpha * M1 + (1 - alpha) * dW1
    M2 = alpha * M2 + (1 - alpha) * db1
    M3 = alpha * M3 + (1 - alpha) * dW2
    M4 = alpha * M4 + (1 - alpha) * db2
    ...
    return W1, W2, b1, b2, M1, M2, M3, M4
...
def gradient_descent(X, Y ,nbr1 ,  alpha, beta, iterations):
    ...
    for i in range(iterations):
        ...
        W1, W2, b1, b2, M1, M2, M3, M4 = momentum(W1, W2, b1, b2, dW1, dW2, db1, db2, alpha, beta, M1, M2, M3, M4)
...
W1, b1, W2, b2 = gradient_descent(X_train, Y_train, nbr1, alpha=0.10, beta=0.9 , iterations=iteration)
